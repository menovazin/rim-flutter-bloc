...
void main() {
  ...
  group('LocationMapper.fromDtoList', () {
    ...
    test('parses list of locations', () async {
      ...
      final locations = LocationMapper.fromDtoList(
        fixtures.map(LocationDto.fromJson).toList(),
      );
