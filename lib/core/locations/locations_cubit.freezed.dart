...
mixin _$LocationsState {
  ...
  @override
  String toString() {
    return 'LocationsState(status: $status, message: $message, items: $items, page: $page, hasNext: $hasNext, isLoadingMore: $isLoadingMore, hasError: $hasError)';
  }
}
...
extension LocationsStatePatterns on LocationsState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(StateStatus status, String message, List<Location> items,
