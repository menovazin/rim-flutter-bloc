...
mixin _$EpisodesState {
  ...
  @override
  String toString() {
    return 'EpisodesState(status: $status, message: $message, items: $items, page: $page, hasNext: $hasNext, isLoadingMore: $isLoadingMore, hasError: $hasError)';
  }
}
...
extension EpisodesStatePatterns on EpisodesState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(StateStatus status, String message, List<Episode> items,
